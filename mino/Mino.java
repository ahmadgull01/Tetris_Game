...
// WILL BE THE SUPER CLASS FOR ALL TE-TORI MINO
public class Mino {
    ...
    private void checkStaticBlockCollision() {
        ...
        for (int i = 0; i < PlayManager.staticBlocks.size(); i++) {
            ...
            for (int ij = 0; ij < b.length; ij++) {
                if (b[ij].y + Block.SIZE == targetY && b[ij].x == targetX) {
                    bottomCollision = true;
                }
            }
            ...
            // CHECK LEFT
            for (int ij = 0; ij < b.length; ij++) {
                if (b[ij].x - Block.SIZE == targetY && b[ij].x == targetX) {
                    bottomCollision = true;
                }
            }
            for (int ij = 0; ij < b.length; ij++) {
    ...
    public void update() {
        ...
        if (KeyHandler.downPressed) {
            // IF MINO BOTTOM IS NOT HITTING IT CAN GO DOWN
        ...
        if (KeyHandler.leftPressed) {
            // IF MINO IS NOT HITTING LEFT WALL IT CAN GO DOWN
        ...
        if (KeyHandler.rightPressed) {
            // IF MINO IS NOT HITTING RIGHT WALL IT CAN GO DOWN
